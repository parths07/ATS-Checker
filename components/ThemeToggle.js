export default function ThemeToggle({ theme, toggleTheme }) {
  return (
    <button
      onClick={toggleTheme}
      className="w-10 h-10 rounded-xl border border-[#2a2a3e] dark:border-[#2a2a3e] 
                 bg-[#f5f5fa] dark:bg-[#1a1a25] 
                 hover:scale-105 hover:border-[#c8c8d8] dark:hover:border-[#3a3a4e]
